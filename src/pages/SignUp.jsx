  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-b from-sky-50 to-white">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100">
        ...
        <h2 className="text-2xl font-bold mb-3 text-center text-gray-800">Create your account</h2>
        <p className="text-sm text-center text-gray-500 mb-6">Create an employee or manager account to continue</p>
