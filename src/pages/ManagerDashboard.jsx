...
const ManagerDashboard = () => {
  ...
  const recentLeaves =  [...leaves].sort((a,b)=> new Date(b.createdAt)-new Date(a.createdAt)).slice(0,5);
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-4xl font-bold text-green-600 mt-2">{approved}</p>
                  </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-red-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-4xl font-bold text-red-600 mt-2">{rejected}</p>
                  </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-600 text-sm font-semibold uppercase">Team Members</p>
                    <p className="text-4xl font-bold text-blue-600 mt-2">{employeesCount}</p>
                  </div>
